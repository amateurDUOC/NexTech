<?php
/**
 * Contact element — override del child theme.
 *
 * Cambio: el ícono de correo ahora enlaza a /contacto/ (WPForms)
 * en vez de abrir el cliente de email (mailto:).
 */
...
$label      = flatsome_option( 'contact_style' ) !== 'icons';
?>
	...
	<ul id="header-contact" class="nav <?php echo $nav; ?> header-contact">
		...
		<li class="<?php echo $class; ?>">
			<a target="_blank" rel="noopener"
			   href="https://maps.google.com/?q=<?php echo flatsome_option( 'contact_location' ); ?>"
			   title="<?php echo flatsome_option( 'contact_location' ); ?>"
			   class="<?php echo $class_link; ?>">
		...
		<li class="<?php echo $class; ?>">
			<a href="<?php echo esc_url( home_url( '/contacto/' ) ); ?>"
			   class="<?php echo $class_link; ?>"
			   title="<?php esc_attr_e( 'Formulario de contacto', 'flatsome' ); ?>">
		...
		<li class="<?php echo $class; ?>">
			<a href="#" onclick="event.preventDefault()"
			   class="<?php echo $class_link; ?>"
			   title="<?php echo $contact_hours; ?><?php if ( $contact_hours_details ) echo ' | ' . $contact_hours_details; ?>">
		...
		<li class="<?php echo $class; ?>">
			<a href="tel:<?php echo flatsome_option( 'contact_phone' ); ?>"
			   class="<?php echo $class_link; ?>"
			   title="<?php echo flatsome_option( 'contact_phone' ); ?>">
		...
		<li class="<?php echo esc_attr( $class ); ?>">
			<a href="<?php echo esc_url( 'https://wa.me/' . get_theme_mod( 'contact_whatsapp', '' ) ); ?>"
			   class="<?php echo esc_attr( $class_link ); ?>"
			   title="<?php echo esc_attr( get_theme_mod( 'contact_whatsapp', '' ) ); ?>"
